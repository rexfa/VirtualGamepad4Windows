...
namespace VirtualGamepad4Windows
{
    ...
    public struct VG4Color
    {
        ...
        public byte green;
        public byte blue;
        public VGColor(System.Drawing.Color c)
        {
            red = c.R;
            green = c.G;
            blue = c.B;
        }
        public VGColor(byte r, byte g, byte b)
        {
            red = r;
            green = g;
            blue = b;
        ...
        public static bool TryParse(string value, ref VGColor ds4color)
        {
            try
            {
    ...
    public struct VGHapticState
    {
        public VGColor LightBarColor;
    ...
    public class VGDevice
    {
        ...
        public VGDevice(HidDevice hidDevice)
        {
            hDevice = hidDevice;
        ...
        private VGHapticState testRumble = new VGHapticState();
        ...
        private VGHapticState[] hapticState = new VGHapticState[1];
        ...
        {
            int i = 0;
            VGColor lightBarColor = LightBarColor;
            ...
            foreach (VGHapticState haptic in hapticState)
            {
        ...
        public void pushHapticState(VGHapticState hs)
        {
            if (hapticStackIndex == hapticState.Length)
            {
                VGHapticState[] newHaptics = new VGHapticState[hapticState.Length + 1];
